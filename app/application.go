...
import (
	...
	gorillaHanlers "github.com/gorilla/handlers"
...
func NewApplication(logger *zap.Logger) *application {
	...
	psr.Use(middlewares.LoggingMiddleware(logger), middlewares.DecodeProductMiddleware(logger), middlewares.ValidateProductIdMiddleware(logger))
...
func (a *application) Start() {
	...
	ch := gorillaHanlers.CORS(gorillaHanlers.AllowedOrigins(strings.Split(ALLOWED_HOSTS, ",")))
